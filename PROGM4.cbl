           ...
           DISPLAY ' Selecione uma opcao: ' ACCEPT WS-OPCAO
            ...
            EVALUATE WS-OPCAO
              WHEN '1'
                 ...
                 CALL 
                 '/home/recic/Dev/Cobol/Desafio M4/Modulos/PROGINCL' 
                 USING WS-COM-AREA

              WHEN '2'
                 MOVE WS-TITULO TO WS-MENSAGEM  
                 CALL 
                 '/home/recic/Dev/Cobol/Desafio M4/Modulos/PROGLIST' 
                 USING WS-COM-AREA

              WHEN '3'
                 MOVE WS-TITULO TO WS-MENSAGEM
                 CALL 
                 '/home/recic/Dev/Cobol/Desafio M4/Modulos/PROGCONS' 
                 USING WS-COM-AREA

              WHEN '4'
                 MOVE WS-TITULO TO WS-MENSAGEM
                 CALL 
                 '/home/recic/Dev/Cobol/Desafio M4/Modulos/PROGALTR' 
                 USING WS-COM-AREA

              WHEN '5'
                 MOVE WS-TITULO TO WS-MENSAGEM
                 CALL 
                 '/home/recic/Dev/Cobol/Desafio M4/Modulos/PROGEXCL' 
                 USING WS-COM-AREA
              WHEN 'F'
