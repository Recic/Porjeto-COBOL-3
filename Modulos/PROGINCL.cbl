      ...
      ******************************************************************
       ...
       FILE-CONTROL.
           ...
           '/home/recic/Dev/Cobol/Desafio M4/Dados/ALUNOS.dat'
           ...
           '/home/recic/Dev/Cobol/Desafio M4/Dados/DISCIPLINAS.dat'
           ORGANIZATION IS INDEXED
           ACCESS MODE IS RANDOM 
           ...
           '/home/recic/Dev/Cobol/Desafio M4/Dados/NOTAS.dat'
           ORGANIZATION IS INDEXED
           ACCESS MODE IS RANDOM 
           ...
           '/home/recic/Dev/Cobol/Desafio M4/Dados/AL-APROV.dat'
           ORGANIZATION IS INDEXED
           ACCESS MODE IS RANDOM 
           RECORD KEY ID-INC-APROV
           FILE STATUS IS WS-FS.

           SELECT AL-REPRO ASSIGN TO 
           '/home/recic/Dev/Cobol/Desafio M4/Dados/AL-REPRO.dat'
           ORGANIZATION IS INDEXED
           ACCESS MODE IS RANDOM 
           RECORD KEY ID-INC-REPRO
           FILE STATUS IS WS-FS.
      ...
      ******************************************************************
       ...
       FD  ALUNOS.
           COPY 
           '/home/recic/Dev/Cobol/Desafio M4/Dados/FD-ALUNOS.cpy'.
           

       FD  DISCIPLINAS.
           COPY 
           '/home/recic/Dev/Cobol/Desafio M4/Dados/FD-DISCIPLINAS.cpy'.

       
       FD  NOTAS.
           COPY 
           '/home/recic/Dev/Cobol/Desafio M4/Dados/FD-NOTAS.cpy'.


       FD  AL-APROV.
           COPY 
           '/home/recic/Dev/Cobol/Desafio M4/Dados/FD-AL-APROV.cpy'.


       FD  AL-REPRO.
           COPY 
           '/home/recic/Dev/Cobol/Desafio M4/Dados/FD-AL-REPRO.cpy'.
           ...
           IF MD-NT > WS-MD
              ...
              END-IF
                 ...
                 IF FS-OK
                    ...
                    WRITE REG-AL-APROV
                    INVALID KEY 
                       DISPLAY 'MEDIA JA CADASTRADA NA LISTA DE APROVAD'
                               'OS'
                    NOT INVALID KEY
             ...
             ELSE 
              ...
              IF WS-FS EQUAL 35 
                 OPEN OUTPUT AL-REPRO
              END-IF
                 
                 IF FS-OK

                    MOVE ID-NT  TO ID-INC-REPRO  IN REG-AL-REPRO
                    MOVE NM-NT  TO NM-ALUNO      IN REG-AL-REPRO
                    MOVE DP-NT  TO NM-DISCIPLINA IN REG-AL-REPRO
                    MOVE MD-NT  TO MD-NOTA       IN REG-AL-REPRO
                    MOVE ST-NT  TO ST-ALUNO      IN REG-AL-REPRO
            
                    WRITE REG-AL-REPRO
                    INVALID KEY 
                       DISPLAY 'MEDIA JA CADASTRADA NA LISTA DE REPROVA'
                               'DOS'
                    NOT INVALID KEY
                       DISPLAY 'CADASTRADO COM SUCESSO NA LISTA DE '
                               'REPROVADOS'
